...
export default function ErpPage() {
  ...
  const loadClientes = useCallback(async () => {
    setLoadingC(true);
    try {
      // Sin filtro de status para mostrar todos los clientes independientemente del estado
      const data = await api.get<Cliente[]>('/mentoria/clientes');
                      ...
                      <button key={c.id} onClick={() => openWorkspace(c.id)}
                        ...
                        <div style={{ padding: '16px 18px' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <span style={{ fontSize: 11, color: fase.color, fontWeight: 600 }}>Ver implementación →</span>
                          </div>
                        </div>
                      </button>
                    );
        ...
        {!showForm ? (
          ...
          <div style={{ padding: '16px 20px' }}>
            ...
            <textarea
              ...
              placeholder="Ej: Al finalizar el diagnóstico, enviar los resultados al email del cliente y actualizar su estado."
