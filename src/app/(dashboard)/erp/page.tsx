...
const PHASES = [
  { num: 0, label: 'Mapeo',          duracion: '~3 semanas', color: '#6c4de6', items: [
  ...
  { num: 1, label: 'Autorizar',      duracion: '~1 semana', color: '#f59e0b', items: [
  ...
  { num: 2, label: 'Entregables',    duracion: '~1 semana', color: '#3b82f6', items: [
  ...
  { num: 3, label: 'Entrega final',  duracion: '1 sesión',  color: '#22c55e', items: [
